...
const PT: Dict = {
  ...
  "apr.pageTitle": "Aprendizados",
  "apr.correctionAmbiente": "Correção de ambiente",
  "apr.correctionM2": "Correção de m²",
  "apr.correctionScope": "Escopo digitado",
  "apr.confirmClearAll": "Apagar TODAS as correções aprendidas ? Os feedbacks de preços não serão afetados.",
  "apr.confirmDeleteLearning": "Apagar esta correção ?",
  "apr.confirmDeleteFeedback": "Apagar este feedback de preço ? Os preços futuros voltarão a ser calibrados apenas com base Rio Centro.",
  "apr.automatic": "automático",
  "apr.favoriteBrands": "Marcas favoritas",
  "apr.mentionedStyles": "Estilos mencionados",
  "apr.budgetProfile": "Perfil de orçamento",
  "apr.workedRooms": "Ambientes trabalhados",
  "apr.usualRange": "Faixa habitual",
  "apr.perChantier": "por chantier",
  "apr.preferencesFooter": "Estas preferências são deduzidas dos seus chats, escopos, notas e chantiers finalizados. Elas não podem ser editadas diretamente — mas se você excluir correções ou feedbacks acima, elas se atualizam.",

  // Share
  "share.title": "Partilhar orçamento",
  "share.public": "Link público, sem conta de usuário",
  ...
  // Compare orçamento
  "compare.title": "Comparar com orçamento",
  "compare.value": "Valor total do orçamento (R$)",
  "compare.valuePlaceholder": "Ex: 18500",
  "compare.detail": "Detalhamento por poste (opcional)",
  "compare.aiRead": "📸 Ler orçamento com IA",
  "compare.aiReadSub": "Lire un devis via IA",
  "compare.chooseFile": "📤 Escolher PDF ou foto",
  "compare.analyzing": "Analisando o orçamento…",
  "compare.aiHelp": "A IA extrai as linhas do orçamento e associa cada uma aos serviços do chantier.",
  "compare.linesRead": "linhas lidas",
  "compare.associated": "associadas a serviços",
  "compare.noMatch": "sem match",
  "compare.compare": "Comparar",
  "compare.result": "Resultado da comparação",
  "compare.received": "Orçamento recebido",
  "compare.estimated": "Nossa estimativa",
  "compare.difference": "Diferença",
  "compare.modeTotal": "Só total",
  "compare.modeDetail": "Detalhado",
  "compare.detailHelp": "Digite o preço do empreiteiro para cada poste que ele detalhou. Deixe em branco os postes sem detalhe.",
  "compare.vsEstimate": "vs nossa estimativa",
  "compare.detailPerPost": "Detalhamento por poste",
  "compare.disclaimer": "Faixa média Rio Centro baseada em SINAPI RJ 2025 e 246 NFs reais. Diferenças podem ser justificadas por qualidade, urgência ou marca específica.",

  // PickMacro / PickQuantity
  "pick.title": "O que você quer fazer?",
  "pick.subtitle": "Escolha um pacote pronto (cômodo completo) ou um serviço específico.",
  "pick.byPhoto": "Analisar por foto",
  "pick.byPhotoSub": "Analyser par photo · IA sugere as macros",
  "pick.search": "Buscar (cozinha, pintura, piso…)",
  "pick.rooms": "Cômodos",
  "pick.roomsSub": "Reforme um ambiente inteiro",
  "pick.services": "Serviços rápidos",
  "pick.servicesSub": "Uma ação específica",
  "pick.structural": "Estrutural",
  "pick.structuralSub": "Alvenaria e obras pesadas",
  "pick.from": "a partir de",
  "pick.quantity": "Quanto?",
  "pick.quantitySub": "Combien ?",
  "pick.suggested": "Padrão sugerido",
  "pick.measureTip": "Meça com uma trena para mais precisão.",
  "pick.next": "Continuar",
  "pick.noResults": "Nada encontrado para \"{search}\".",
  "pick.per": "por",
  "pick.back": "voltar",
  "pick.whichSize": "Qual o tamanho?",
  "pick.measureAdjust": "Meça a área e ajuste",
  "pick.seeDetail": "Ver detalhamento",

  // Loading + est complements (WIP i18n)
  "common.loading": "Carregando…",
  "est.total": "Total",
  "est.editingSaved": "Editando chantier salvo",
  "est.contractType": "Tipo de contrato",
  "est.materialMode": "Modo material",
  "est.serviceDetailSoon": "Lista detalhada em breve para este serviço.",
  "est.sinapiYield": "Rendimento SINAPI",
  "est.quantity": "Quantidade",
  "est.teamName": "Equipe do chantier",
  "est.addServiceShort": "Adicionar serviço",
  "est.noServiceAvailable": "Nenhum serviço disponível.",
...
const FR: Dict = {
  ...
  "apr.pageTitle": "Apprentissages",
  "apr.correctionAmbiente": "Correction de pièce",
  "apr.correctionM2": "Correction de m²",
  "apr.correctionScope": "Scope écrit",
  "apr.confirmClearAll": "Effacer TOUTES les corrections apprises ? Les feedbacks de prix ne seront pas affectés.",
  "apr.confirmDeleteLearning": "Effacer cette correction ?",
  "apr.confirmDeleteFeedback": "Effacer ce feedback de prix ? Les prix futurs seront à nouveau calibrés uniquement sur la base Rio Centro.",
  "apr.automatic": "automatique",
  "apr.favoriteBrands": "Marques favorites",
  "apr.mentionedStyles": "Styles mentionnés",
  "apr.budgetProfile": "Profil de budget",
  "apr.workedRooms": "Pièces travaillées",
  "apr.usualRange": "Fourchette habituelle",
  "apr.perChantier": "par chantier",
  "apr.preferencesFooter": "Ces préférences sont déduites de tes conversations, scopes, notes et chantiers finalisés. Elles ne peuvent pas être éditées directement — mais si tu supprimes des corrections ou feedbacks ci-dessus, elles se mettent à jour.",
  ...
  // Compare orçamento
  "compare.title": "Comparer avec un devis",
  "compare.value": "Valeur totale du devis (R$)",
  "compare.valuePlaceholder": "Ex: 18500",
  "compare.detail": "Détail par poste (optionnel)",
  "compare.aiRead": "📸 Lire le devis avec l'IA",
  "compare.aiReadSub": "Ler orçamento com IA",
  "compare.chooseFile": "📤 Choisir PDF ou photo",
  "compare.analyzing": "Analyse du devis en cours…",
  "compare.aiHelp": "L'IA extrait les lignes du devis reçu et associe chacune aux services du chantier.",
  "compare.linesRead": "lignes lues",
  "compare.associated": "associées à des services",
  "compare.noMatch": "sans match",
  "compare.compare": "Comparer",
  "compare.result": "Résultat de la comparaison",
  "compare.received": "Devis reçu",
  "compare.estimated": "Notre estimation",
  "compare.difference": "Différence",
  "compare.modeTotal": "Seulement total",
  "compare.modeDetail": "Détaillé",
  "compare.detailHelp": "Écris le prix de l'entreprise pour chaque poste qu'elle a détaillé. Laisse vide les postes non détaillés.",
  "compare.vsEstimate": "vs notre estimation",
  "compare.detailPerPost": "Détail par poste",
  "compare.disclaimer": "Fourchette moyenne Rio Centro basée sur SINAPI RJ 2025 et 246 factures réelles. Les écarts peuvent être justifiés par qualité, urgence ou marque spécifique.",

  // PickMacro / PickQuantity
  "pick.title": "Que veux-tu faire ?",
  "pick.subtitle": "Choisis un pack tout prêt (pièce complète) ou un service ponctuel.",
  "pick.byPhoto": "Analyser par photo",
  "pick.byPhotoSub": "L'IA propose les macros",
  "pick.search": "Rechercher (cuisine, peinture, sol…)",
  "pick.rooms": "Pièces",
  "pick.roomsSub": "Rénove un espace entier",
  "pick.services": "Services rapides",
  "pick.servicesSub": "Une action ponctuelle",
  "pick.structural": "Structurel",
  "pick.structuralSub": "Maçonnerie et gros œuvre",
  "pick.from": "à partir de",
  "pick.quantity": "Combien ?",
  "pick.quantitySub": "Quanto ?",
  "pick.suggested": "Quantité suggérée",
  "pick.measureTip": "Mesure au mètre pour plus de précision.",
  "pick.next": "Continuer",
  "pick.noResults": "Rien trouvé pour \"{search}\".",
  "pick.per": "par",
  "pick.back": "retour",
  "pick.whichSize": "Quelle taille ?",
  "pick.measureAdjust": "Mesure la surface et ajuste",
  "pick.seeDetail": "Voir le détail",

  // Loading + est complements (WIP i18n)
  "common.loading": "Chargement…",
  "est.total": "Total",
  "est.editingSaved": "Édition d'un chantier enregistré",
  "est.contractType": "Type de contrat",
  "est.materialMode": "Mode matériel",
  "est.serviceDetailSoon": "Détail par ligne bientôt disponible pour ce service.",
  "est.sinapiYield": "Rendement SINAPI",
  "est.quantity": "Quantité",
  "est.teamName": "Équipe du chantier",
  "est.addServiceShort": "Ajouter un service",
  "est.noServiceAvailable": "Aucun service disponible.",
